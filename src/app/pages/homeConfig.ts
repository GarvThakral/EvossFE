export const DEFAULT_HOME_CONFIG = {
  hero: {
    ...
    titleLineOne: 'Unlocking the',
    titleAccent: 'Power of',
    titleEmphasis: 'Visual',
    titleLineTwo: 'Intelligence',
    subtitle:
    ...
    statusPill: 'Available for Engagements',
    tickerText: 'Vision Intelligence · AI Solutions · Since 2013',
    badgeValue: '12',
    badgeLabel: 'Years',
    badgeTag: 'of Alpha',
...
export type HomeConfig = typeof DEFAULT_HOME_CONFIG;
